...
- `processedData/00-source-inventory.md` — files and historical-input check.
- `processedData/01-requirements-normalized.md` — grouped requirements.
- `processedData/02-current-evidence.md` — verified baseline and stale-audit reconciliation.
- `processedData/03-existing-architecture.md` — strengths and risks to preserve/address.
