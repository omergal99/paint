...
1. Phase 2 is planning-only in this turn; no application code is changed.
...
| Advanced background removal | Pyodide/WebAssembly in browser, optional local Python service, or remote API | Optional local/service adapter; do not inflate the default bundle or upload images silently. |
